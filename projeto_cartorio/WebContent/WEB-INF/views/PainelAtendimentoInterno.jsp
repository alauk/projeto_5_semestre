          ...
          <table>
            <thead>
              <tr class="row100 head">
              	<th class="cell100 column1" style="width:100px"><b>Senha</b></th>
                <th class="cell100 column5" style="width:100px"><b>Horário Chegada</b></th>
                <th class="cell100 column4" style="width:100px"><b>Prév. Início</b></th>
                <th class="cell100 column2" style="width:100px"><b>Prév. Fim</b></th>
              </tr>
            </thead>
          </table>
        </div><br>
          ...
          <tbody>
             <c:forEach var="a" items="${atendimentos}">
	            <tr class="row100 body">
	              <td class="cell100 column1">${a.senha.codigo }</td>
	              <td class="cell100 column2" style="width:100px" ><fmt:formatDate value="${a.dataInicio }" pattern="HH:mm:ss"/></td>
	              <td class="cell100 column3 " style="width:100px" ><fmt:formatDate value="${a.previsaoInicio }" pattern="HH:mm:ss"/></td>
	              <td class="cell100 column4"  style="width:100px" ><fmt:formatDate value="${a.previsaoTermino }" pattern="HH:mm:ss"/></td>
	            </tr>
             </c:forEach>
          </tbody>
        </table>
